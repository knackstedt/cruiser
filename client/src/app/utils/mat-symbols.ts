/**
 * Data ingested from the following URI:
 *      https://fonts.google.com/metadata/icons?key=material_symbols&incomplete=true
 *
 * Then filtered & processed with the following logic:
 *      .filter(t => !t.unsupported_families?.includes('Material Symbols Outlined')).map(i => i.name)
 */
